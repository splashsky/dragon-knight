...
CREATE TABLE {{ table }} (
  ...
  hp smallint unsigned NOT NULL default '15',
  mp smallint unsigned NOT NULL default '0',
  tp smallint unsigned NOT NULL default '10',
  max_hp smallint unsigned NOT NULL default '15',
  max_mp smallint unsigned NOT NULL default '0',
  max_tp smallint unsigned NOT NULL default '10',
